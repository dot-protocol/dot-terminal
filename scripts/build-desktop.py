...
p=argparse.ArgumentParser();p.add_argument('--install',action='store_true');p.add_argument('--iterm',action='store_true');p.add_argument('--test-app',action='store_true');args=p.parse_args()
