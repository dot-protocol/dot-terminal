...
| Android client and local model | USB development client implemented; inference planned | Real-device remote handoff, offline inference, lifecycle/memory/battery measurements |
